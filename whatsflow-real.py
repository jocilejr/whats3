...
def _load_minio_configuration() -> Tuple[str, str, str, str, Optional[str]]:
    ...
    legacy_endpoint = (
        ...
        and _normalize_endpoint_for_comparison(stored_endpoint)
        in LEGACY_MINIO_ENDPOINT_FINGERPRINTS
    )
fix-minio-upload-connection-error-440wra
    ...
    endpoint_raw = _choose(env_endpoint, stored_endpoint, DEFAULT_MINIO_ENDPOINT)
